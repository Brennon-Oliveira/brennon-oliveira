        ...
        "guia-de-programacao": [
            {
                ...
                data: (
                    <>
                        ...
                        <Text>
                            Ola a todos, esse é o primeiro epsódio do "Guia de
                            programação". Essa vai ser uma série de vídeos
                            ensinando os princípios da programação, desde o
                            básico até temas mais avançados.
                        </Text>
                        <Text>
                            Nessa série, usaremos Javascript, Typescript e Java
                            para entender os fundamentos da programação.
                        </Text>
                        <Text>
                            E agora, nesse primeiro ep vamos entender as
                            variáveis.
                        </Text>
                        <Text>
                            Primeiramente, variáveis são valores que vamos "usar
                            mais tarde". São nelas que vamos salvar e gerenciar
                            os dados da nossa aplicação.
                        </Text>
                        <Text>
                            Vamos começar do início, primeiro, precisamos
                            entender os valores.
                        </Text>
...
`}
                        ...
                        <Text>
                            As variáveis são locais feitos para salvarmos um
                            valor. Podemos salvar, alterar e usar esses valores
                            durante a execução do nosso aplicativo.
                        </Text>
                        <Text>
                            No javascript, vamos usar a palavra especial "var"
                            para criarmos novas variáveis
                        </Text>
                        <Text>Javascript:</Text>
                        <SyntaxHighlighter
                            language="javascript"
...
`}
                        ...
                        * Para isso, precisamos considerar que, é melhor nomes grandes do que nomes
                        * pouco legíveis.
                        * Por exemplo:
                        */
    ...
    const currentClass = postsList[params.post].find(
        (val) => val.id === params.class
    );
